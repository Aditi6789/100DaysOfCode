...
def get_digit_count(n):
    ...
    Args:
        num(int): The number to count digits for.
    Returns:
...
def power_of(digit,power):
    ...
    Args:
       digit (int): The base digit.
       pow (int): The power to raise the digit
    Returns:
       int: The result of raising the digit to the given number.
    """
    prod=1 
    while power>0:
        prod *= digit
